...
sample of `r nrow(nycflights)` domestic flights that departed from the three major 
...
We begin by loading the data set of `r nrow(nycflights)` observations into the R 
