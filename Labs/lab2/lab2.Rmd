...
download("http://garciarios.github.io/govt_3990/Labs/lab2/lab2.Rmd", 
         destfile = "lab2.Rmd")
```
</div>
...
1. **Data Overiew**
    ...
    + How many variables?
    +  For each variable, identify its data type (e.g. categorical: ordinal or not,
...
This lab was adapted from OpenIntro by Andrew Bray and Mine Mine Cetinkaya-Rundel.
</div>