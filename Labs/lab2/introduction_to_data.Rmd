...
We begin by loading the data set of 20,000 observations into the R work space. 
...
The data set `cdc` that shows up in your work space is a *data matrix*, with each
...
This functions says to plot `age` on the x-axis, this information and more goes into the aesthetic components `aes`. It also defines a `geom` (short for 
