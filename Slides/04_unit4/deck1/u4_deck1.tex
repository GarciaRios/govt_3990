...
\documentclass[t,compress,mathserif,11pt,t,professionalfonts,xcolor=table]{beamer}
...
\disc{What happens to shape of the $t$-distribution as $df$ increases?} \pause
\twocol{0.75}{0.25}{
\begin{center}
...
\disc{{\small Since 2005, the American Community Survey polls $\sim$3.5 million households yearly...} \pause 

\scriptsize{\textit{Aside: Surge of media attention in spring 2012 when the House 
of Representatives voted to eliminate the survey. Daniel Webster, Republican congressman from Florida had an interesting opinion:}}}

\begin{center}

\includegraphics<3>[width=.95\textwidth]{figures/random_not_sci/random2}
\end{center}
