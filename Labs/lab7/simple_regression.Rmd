...
download.file("https://raw.githubusercontent.com/GarciaRios/govt_3990/gh-pages/Labs/lab7/lab7.Rmd", destfile = "lab777.Rmd")
```
</div>
...
7.  Based on the histogram, does the nearly 
...
<div id="license">
Science at Cornell and everywhere should be free and open source! 
