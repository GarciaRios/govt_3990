...
#download("https://raw.githubusercontent.com/GarciaRios/govt_3990/gh-pages/Labs/lab4/lab4.Rmd", destfile = "lab4.Rmd")
```
</div>
...
interest. Let's load the data...

```{r}
load(load(url("https://raw.githubusercontent.com/GarciaRios/govt_3990/gh-pages/Labs/lab4/data/ames.RData")
...
block is finding the appropriate critical value for a given confidence level. Instead of using the tales, we can
