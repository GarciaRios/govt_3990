...
\documentclass[slidestop,compress,mathserif,10pt,t,professionalfonts,xcolor=table]{beamer}
...
\disc{How can we determine if it would be unusual for an adult woman in Ithaca to be 
96'' (8 ft) tall?}
