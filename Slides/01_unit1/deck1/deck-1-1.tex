...
data from the Cornell Squirrel Center. We use the sample mean from these data as an 
estimate for the unknown population mean. Can you see any limitations to using data 
from the Cornell Squirrel Center to make inferences about all squirrels?
\end{exampleblock}
}
