...
%\item 
%
%\item While I am away... 
%\begin{itemize}
%\item My colleague we will have Bryce Corrigan   
...
\textit{The confidence level is equal to the proportion of random samples that result in confidence intervals that contain the true pop. parameter.} \\
...
\app{3.1 Confidence interval for a single mean}{}
