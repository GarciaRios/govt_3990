...
download.file("https://raw.githubusercontent.com/GarciaRios/govt_3990/gh-pages/Labs/lab8/lab8.Rmd", destfile = "lab8.Rmd")
```
</div>
...
6. Using `predict`, produce predicted values for a "real world" assessment of what the model might be telling you. 
...
18. Based on your final model, describe the characteristics of a professor and 
    ...
    evaluation score. In order to do this, predict at least two scenarios and plot the predicted values fro those scenarios
